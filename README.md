...
├── doc/         architecture, data, model_card, api, testing_system, reproducibility
├── notebooks/   analytical_report.ipynb
└── requirements.txt
```

Подробности -- в `doc/` (архитектура, данные, карточка модели, контракт API, реестр
тестов, сценарий воспроизводимости).
